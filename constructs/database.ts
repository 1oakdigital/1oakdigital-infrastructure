...
export class AuroraPostgresqlServerlessCluster {
  ...
  constructor(
    stack: string,
    props: AuroraPostgresqlClusterProps,
    tags?: { [key: string]: string }
  ) {
    const constructName = props.databaseName
      ? `${stack}-${props.databaseName}`
      : stack;
